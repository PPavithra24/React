...
export default class WatchListComponent extends React.Component{
    ...
    render() {
        ...
        <div ><h3>Watch List is empty</h3></div>
        :
         (
        ...
        this.state.data.map((company)=>{
            ...
            <div class="card-col col col-md-4 col-xs-12">
                <CompanyDetailsComponent class="remove" isLoggedin={this.state.isLoggedin} handleRemove={this.handleRemove} key={company.company.id} company={company.company}/>
            </div>
            )
        })
        }
